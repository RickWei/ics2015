...
make_helper(decode_rm2rm_b);
make_helper(decode_rm2rm_w);
make_helper(decode_rm2rm_l);
...
make_helper(decode_rml2r_w);
make_helper(decode_rml2r_l);
make_helper(decode_jrm_w);
make_helper(decode_jrm_l);
make_helper(decode_jrm_b);
